...
class StaffSkillSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('staff_skill')->insert([
            ...
            ['staff_id' => 1, 'skill_id' => 9, 'proficiency_id' => 2, 'created_at' => now(), 'updated_at' => now()],
            ['staff_id' => 1, 'skill_id' => 16, 'proficiency_id' => 2, 'created_at' => now(), 'updated_at' => now()],
            ['staff_id' => 1, 'skill_id' => 17, 'proficiency_id' => 2, 'created_at' => now(), 'updated_at' => now()],
            ['staff_id' => 1, 'skill_id' => 18, 'proficiency_id' => 2, 'created_at' => now(), 'updated_at' => now()],
